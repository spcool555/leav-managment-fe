            ...
            <div className="text-center">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                {leaveStats ? (
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span>Compensatory_off Leave:</span>
                      <span className="text-purple-600 font-medium">
                      {leaveStats?.Compensatory_off_leave?.remaining ?? 0}/{leaveStats?.Compensatory_off_leave?.total ?? 0} days
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-red-600 font-medium">
                        {leaveStats?.sick_leave?.remaining ?? 0}/{leaveStats?.sick_leave?.total ?? 0} days
                      </span>
                    </div>
                    <div className="flex justify-between pt-2 border-t border-gray-200">
                      <span className="font-medium">Total Used:</span>
                      <span className="text-orange-600 font-medium">{leaveStats?.total_used ?? 0} days</span>
                    </div>
                  </div>
                ) : (
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Office starts at 9:30 am (15 min grace period till 9:45 am)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Checks out before completing the minimum working hours will lead to Half Day (Second Half Absent).</li>
